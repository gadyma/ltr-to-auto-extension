...
echo -e "${GREEN}📄 Creating popup.html (with domain control UI)${NC}"
cat > popup.html << 'EOF'
<!DOCTYPE html>
...
echo -e "${GREEN}📄 Creating popup.js (with domain control logic)${NC}"
cat > popup.js << 'EOF'
...
echo -e "   ${GREEN}✓${NC} manifest.json (v1.23)"
